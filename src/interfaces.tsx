...
export type SSMLChildren =
  | string
  | SSMLElement<any>
  | Array<SSMLElement<any> | string>;
...
export type AlexaSpeechComponent<T extends Request = Request, U = unknown> = FC<
  AlexaSpeechComponentProps<T, U>
> | null;
export type AlexaSpeechComponentFunction<
  T extends Request = Request,
  U = unknown
> = (
  props: AlexaSpeechComponentProps<T, U>
) => FC | JSX.Element | JSX.Element[];
